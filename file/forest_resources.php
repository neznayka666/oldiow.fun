...
$rt=mysql_query("SELECT * FROM resources_forest order by `price` ASC");
...
<td width='80' align='center'><img src='//oldiow.fun/images/weapons/resources_forest/".$res["image"].".gif' title='".$res["name"]."'></td>
