...
function show_pers_new (sh,shd,oj,ojd,or1,or1d,po,pod,z1,z1d,z2,z2d,z3,z3d,sa,sad,na,nad,pe,ped,or2,or2d,braslet1,braslet1d,braslet2,braslet2d,br,brd,pers,inv,sign,nick,level,hp,mhp,ma,mma,tire,kam1,kam2,kam1d,kam2d,i,dil,lo,lod,kolco1,kolco1d,kolco2,kolco2d,kolco3,kolco3d,kolco4,kolco4d,kolco5,kolco5d,kolco6,kolco6d)

{
	var d=document;
	if (tire==undefined) tire=0;
	var s = 'style=\'cursor:pointer;\' onclick =\'location="main.php?';
	var sha,oja,or1a,poa,z1a,z2a,z3a,saa,naa,pea,or2a,braslet1a,braslet2a,bra,kam1a,kam2a,pea,loa,kolco1a,kolco2a,kolco3a,kolco4a,kolco5a,kolco6a;
	if (inv==1)
	{
	...
	d.write('<table width="100%" cellspacing="0" cellpadding="0" class="peachBlock">');
...
d.write('</div>');
d.write('<div class="td" style="display: table-cell;width:100px;text-align:center;position:relative;">');
d.write('<img style="position:absolute;bottom:0px;left:4px;" src="/images/persons/'+pers+'.gif" title="'+nick+'" width="100" height="225">');
...
var zma = w-no_ma;
	return `
	<br><b class="hp">Уровень жизни:</b> <span id="chp" class="hp"> ${hp}/${mhp}</span> 
	<br><b class="ma">Уровень энергии:</b> <span id="cma" class="ma"> ${ma}/${mma}</span>

	<table border="1" width="230" cellspacing="0" cellpadding="0">
	<tr> 		
	<td width="26" style="display:none;"><img border="0" src="/public_content/ypimg/hp_left.gif"></td> 		
	<td align=center> 		
	<table border="0" width="100%" cellspacing="0" cellpadding="0"><tr> 				
	<td title="" id=hptitle><img border="0" src="/public_content/ypimg/hp.gif" width="${zhp}" height="8" name=hp style="display:none;">
	<img border="0" src="/public_content/ypimg/no.png" width="${no_hp}" height="8" name=no_hp style="display:none;"></td>
	</tr>
	<tr class=login style="display:none;">
		<td id=chp class=hp>${hp}/${mhp}</td> <td id=cma class=ma align=right>${ma}/${mma}</td>
	</tr>
	<tr>
	<td title="" id=matitle><img border="0" src="/public_content/ypimg/ma.gif" width="${zma}" height="8" name=ma style="display:none;">
	<img border="0" src="/public_content/ypimg/no.png" width="${no_ma}" height="8" name=no_ma style="display:none;"></td>
	</tr></table>
	</td>
	<td width="26" align=left><img border="0" src="/public_content/ypimg/hp_right.gif" style="display:none;"></td>
	</tr></table>	
	`;
	/*return `
<table border="1" width="230" cellspacing="3" cellpadding="3">
<tr>
<td id="chp">Уровень жизни: <span class="hp">${hp}/${mhp}</span></td>
</tr><tr>
<td id="cma">Уровень энергии: <span class="ma">${ma}/${mma}</span></td>
</tr>
</table>`;*/
}