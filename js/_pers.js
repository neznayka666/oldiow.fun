...
//d.write('<img src="//'+img_pack+'/weapons/slots/slot1.gif" width=60 height=20><img src="//'+img_pack+'/weapons/'+na+'.gif" width=60 height=40 onmouseover="s_des(event,\''+nad+'\')" onmouseout="h_des()" '+naa+' onmousemove=move_alt(event)><img  src=//'+img_pack+'/weapons/'+pe+'.gif width=60 height=40 onmouseover="s_des(event,\''+ped+'\')" onmouseout="h_des()" '+pea+' onmousemove=move_alt(event)><img  src="//'+img_pack+'/weapons/'+or1+'.gif" width=60 height=91 onmouseover="s_des(event,\''+or1d+'\')" onmouseout="h_des()" '+or1a+' onmousemove=move_alt(event)><img  src="//'+img_pack+'/weapons/'+br+'.gif" width=60 height=90 onmouseover="s_des(event,\''+brd+'\')" onmouseout="h_des()" '+bra+' onmousemove=move_alt(event)></td> <td align=center width=115><img src="//'+img_pack+'/persons/'+pers+'.gif" title="'+nick+'" width=115></td><td width=60 valign=top align=right><img src="//'+img_pack+'/weapons/'+sh+'.gif" width=60 height=65 onmouseover="s_des(event,\''+shd+'\')" onmouseout="h_des()" '+sha+' onmousemove=move_alt(event)><img src="//'+img_pack+'/weapons/'+oj+'.gif" width=60 height=35 onmouseover="s_des(event,\''+ojd+'\')" onmouseout="h_des()" '+oja+' onmousemove=move_alt(event)><img src="//'+img_pack+'/weapons/'+or2+'.gif" width=60 height=91 onmouseover="s_des(event,\''+or2d+'\')" onmouseout="h_des()" '+or2a+' onmousemove=move_alt(event)><img src="//'+img_pack+'/weapons/'+po+'.gif" width=60 height=30 onmouseover="s_des(event,\''+pod+'\')" onmouseout="h_des()" '+poa+' onmousemove=move_alt(event)><img src="//'+img_pack+'/weapons/'+sa+'.gif" width=60 height=60 onmouseover="s_des(event,\''+sad+'\')" onmouseout="h_des()" '+saa+' onmousemove=move_alt(event)></td></tr><tr><td align=left width=100%><img src="//'+img_pack+'/weapons/'+kam1+'.gif" width=31 height=31 onmouseover="s_des(event,\''+kam1d+'\')" onmouseout="h_des()" '+kam1a+' onmousemove=move_alt(event)><img src="//'+img_pack+'/weapons/'+kam2+'.gif" width=31 height=31 onmouseover="s_des(event,\''+kam2d+'\')" onmouseout="h_des()" '+kam2a+' onmousemove=move_alt(event)></td><td align=center><img src="//'+img_pack+'/weapons/'+ko1+'.gif" width=31 height=31 onmouseover="s_des(event,\''+ko1d+'\')" onmouseout="h_des()" '+ko1a+' onmousemove=move_alt(event)><img src="//'+img_pack+'/weapons/'+ko2+'.gif" width=31 height=31 onmouseover="s_des(event,\''+ko2d+'\')" onmouseout="h_des()" '+ko2a+' onmousemove=move_alt(event)></td><td align=right><img src="//'+img_pack+'/weapons/'+kam3+'.gif" width=31 height=31 onmouseover="s_des(event,\''+kam3d+'\')" onmouseout="h_des()" '+kam3a+' onmousemove=move_alt(event)><img src="//'+img_pack+'/weapons/'+kam4+'.gif" width=31 height=31 onmouseover="s_des(event,\''+kam4d+'\')" onmouseout="h_des()" '+kam4a+' onmousemove=move_alt(event)></td> <td height=32 align=right valign=bottom></td></tr></table></td> <td width=30 height=272 valign=bottom> </td></tr></table></td></tr></table>');
//d.write('<img src="//'+img_pack+'/weapons/'+sh+'.gif" width=60 height=60 onmouseover="s_des(event,\''+shd+'\')" onmouseout="h_des()" '+sha+' onmousemove=move_alt(event)><img src="//'+img_pack+'/weapons/'+oj+'.gif" width=60 height=20 onmouseover="s_des(event,\''+ojd+'\')" onmouseout="h_des()" '+oja+' onmousemove=move_alt(event)><img  src="//'+img_pack+'/weapons/'+or1+'.gif" width=60 height=80 onmouseover="s_des(event,\''+or1d+'\')" onmouseout="h_des()" '+or1a+' onmousemove=move_alt(event)><img src="//'+img_pack+'/weapons/'+po+'.gif" width=60 height=30 onmouseover="s_des(event,\''+pod+'\')" onmouseout="h_des()" '+poa+' onmousemove=move_alt(event)><img src="//'+img_pack+'/weapons/'+sa+'.gif" width=60 height=63 onmouseover="s_des(event,\''+sad+'\')" onmouseout="h_des()" '+saa+' onmousemove=move_alt(event)></td> <td align=center width=115><img src="images/persons/'+pers+'.gif" title="'+nick+'" width=115></td><td width=60 valign=top align=right><img src="//'+img_pack+'/weapons/slots/slot1.gif" width=60 height=12><img src="//'+img_pack+'/weapons/'+na+'.gif" width=60 height=40 onmouseover="s_des(event,\''+nad+'\')" onmouseout="h_des()" '+naa+' onmousemove=move_alt(event)><img  src=//'+img_pack+'/weapons/'+pe+'.gif width=60 height=40 onmouseover="s_des(event,\''+ped+'\')" onmouseout="h_des()" '+pea+' onmousemove=move_alt(event)><img src="//'+img_pack+'/weapons/'+or2+'.gif" width=60 height=91 onmouseover="s_des(event,\''+or2d+'\')" onmouseout="h_des()" '+or2a+' onmousemove=move_alt(event)><img src="//'+img_pack+'/weapons/'+braslet1+'.gif" width=30 height=20 onmouseover="s_des(event,\''+braslet1d+'\')" onmouseout="h_des()" '+braslet1a+' onmousemove=move_alt(event)><img src="//'+img_pack+'/weapons/'+braslet2+'.gif" width=30 height=20 onmouseover="s_des(event,\''+braslet2d+'\')" onmouseout="h_des()" '+braslet2a+' onmousemove=move_alt(event)><img  src="//'+img_pack+'/weapons/'+br+'.gif" width=60 height=90 onmouseover="s_des(event,\''+brd+'\')" onmouseout="h_des()" '+bra+' onmousemove=move_alt(event)></td></tr></table></td></tr></table></td></tr></table>');
...
d.write('<table border="0" width="220" cellspacing="0" cellpadding="0"> 	<tr> 		<td width="26"><img border="0" src="//'+img_pack+'/design/hot/hp_left.gif"></td> 		<td align=center> 		<table border="0" width="100%" cellspacing="0" cellpadding="0"> 			<tr> 				<td colspan="2" title="" id=hptitle><img border="0" src="//'+img_pack+'/design/new/hp.gif" width="'+zhp+'" height="8" name=hp><img border="0" src="//'+img_pack+'/no.png" width='+no_hp+' height="8" name=no_hp></td> 			</tr> 			<tr class=login> 				<td id=chp class=hp>'+hp+'/'+mhp+'</td> <td id=cma class=ma align=right>'+ma+'/'+mma+'</td> 			</tr> 			<tr> 				<td colspan="2" title="" id=matitle><img border="0" src="//'+img_pack+'/design/new/ma.gif" width="'+zma+'" height="8" name=ma><img border="0" src="//'+img_pack+'/no.png" width='+no_ma+' height="8" name=no_ma></td> 			</tr> 		</table> 		</td> 		<td width="26" align=left><img border="0" src="//'+img_pack+'/design/hot/hp_right.gif"></td> 	</tr> </table>');
}
...
return '<table border="0" width="230" cellspacing="0" cellpadding="0"> 	<tr> 		<td width="26"><img border="0" src="//'+img_pack+'/design/hot/hp_left.gif"></td> 		<td align=center> 		<table border="0" width="100%" cellspacing="0" cellpadding="0"> 			<tr> 				<td colspan="2" title="" id=hptitle><img border="0" src="//'+img_pack+'/design/new/hp.gif" width="'+zhp+'" height="8" name=hp><img border="0" src="//'+img_pack+'/no.png" width='+no_hp+' height="8" name=no_hp></td> 			</tr> 			<tr class=login> 				<td id=chp class=hp>'+hp+'/'+mhp+'</td> <td id=cma class=ma align=right>'+ma+'/'+mma+'</td> 			</tr> 			<tr> 				<td colspan="2" title="" id=matitle><img border="0" src="//'+img_pack+'/design/new/ma.gif" width="'+zma+'" height="8" name=ma><img border="0" src="//'+img_pack+'/no.png" width='+no_ma+' height="8" name=no_ma></td> 			</tr> 		</table> 		</td> 		<td width="26" align=left><img border="0" src="//'+img_pack+'/design/hot/hp_right.gif"></td> 	</tr> </table>';
}
*/