...
document.write('<div style="position:absolute; left:0px; top:0px; z-index: 2; width:300 ; height:400; visibility:hidden; background-color: #FFFFFF;padding:15px;" id="ml" class="loc">&nbsp;</div>');
...
function editw()
{
	...
	d.write('<tr><td class="inv" id="o" width="50%" valign="top"></td><td class="inv" id="t" width="50%" valign="top"></td></tr>');
...
function main_inf()
{
	...
	z += '<tr><td align="center" colspan="3">';
	...
	z += '| <a href="#" onclick="ch_price()"> '+par_val('dprice')+'</a> сп. | Вес : <a href="#" onclick="ch_weight()"> '+par_val('weight')+' </a>';	
	z += '</td></tr>';
	z += '<tr><td align="center" colspan="3">';
	z += 'МАКС. Долговечность: <a href="#" onclick="ch_dur_qs()"> '+par_val('max_durability')+'</a> | ';
	z += 'Текущее кол-во в лавке: <a href="#" onclick="ch_dur_qs()"> '+par_val('q_s')+'</a> шт. | ';
	z += '<a href="#" onclick="ch_describe()"> Описание: '+par_val('describe')+'</a>';
	z += '</td></tr>';
	z += '<tr><td align="center" colspan="3">';
	z += 'Название заряда: <a href="#" onclick="ch_arrows()">'+par_val('arrow_name')+'</a> | ';
	z += 'Цена заряда: <a href="#" onclick="ch_arrows()">'+par_val('arrow_price')+'</a> | ';
	z += 'Максимально зарядов: <a href="#" onclick="ch_arrows()">'+par_val('arrows')+'</a> | ';
	z += 'Радиус поражения: <a href="#" onclick="ch_arrows()">'+par_val('radius')+'</a> | ';
	z += 'Кол-во слотов: <a href="#" onclick="ch_arrows()">'+par_val('slots')+'</a>';
	z += '</td></tr>';	
