...
function show_w (name,sht,img,d,m_d,cena,pric,dprice,stype,art,attr,describe,present,clan_sign,clan_name,slots,radius,arrows,arrows_max,arrow_name,z_time,weight,index,trbs)
{
	var text = '';
