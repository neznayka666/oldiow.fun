...
s+=' | <img src="images/icons/battle/clock.gif" title="Таймаут">: <font title="Таймаут[Лог боя]" style="color:red;" class="timef" id="timeout">'+timeout+'</font><a href="fight.php?id='+logid+'" target="_blank" class="timef"><img src="images/icons/battle/log.gif" title="Лог поединка №'+logid+'"></a></td></tr><tr><td id="odd" width="50%" align="center"></td></tr></table>';
