...
s+=' | <a href="fight.php?id='+logid+'" target="_blank" class="timef">Таймаут: <font title="Таймаут[Лог боя]" style="color:red;" class="timef" id="timeout">'+timeout+'</font></a></td></tr><tr><td id="odd" width="50%" align="center"></td></tr></table>';
