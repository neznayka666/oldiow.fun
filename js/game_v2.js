...
function view_frames()
{
	dw("<div id='gameMain'>");
dw("<div class='tr'>");
dw("<div class='td top' id='maintd'>");
dw("<iframe src='/main.php' id='main_top' name='main_top' scrolling='auto' noResize class='iframe wh100'>Обновите браузер.</iframe>");
dw("</div>");
dw("</div>");
dw("<div class='tr'>");
dw("<div class='td resize' onmousedown='InitResize();'>");
dw("<div class='bg'>");
dw("<div class='left'></div>");
dw("<div class='right'></div>");   
dw("</div>");
dw("</div>");
dw("</div>");
dw("<div class='tr'>");
dw("<div class='chatBlock'>");
dw("<div class='chat' id='chtd1'>");
dw("<iframe src='/frames/chat.php' id='chmain' name='chmain' scrolling='auto' noResize class='iframe2 wh100'>Обновите браузер.</iframe>");
dw("</div>");
dw("<div class='chatLine'></div>");
dw("<div class='chatList' id='chtd2'>");
dw("<iframe src='/frames/ch.php' id='ch_list' name='ch_list' scrolling='auto' noResize class='iframe2 wh100'>Обновите браузер.</iframe>");
dw("</div>");
dw("</div>");
dw("</div>");
dw("<div class='tr'>");     
dw("<div class='td bottom'>");
dw("<iframe src='/frames/but.php' id='ch_buttons' name='ch_buttons' scrolling='no' noResize class='wh100'>Обновите браузер.</iframe>");
dw("</div>");
dw("</div>");
dw("</div>");
