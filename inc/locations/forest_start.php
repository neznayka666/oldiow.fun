...
$lavka = 1;
$enures= $db->sql("SELECT * FROM `weapons` WHERE (`p_type`='5' or `p_type`='17' or `p_type`='18') AND `where_buy`='0' or `name`='Малый рюкзак' ORDER BY `price` ASC", __FILE__,__LINE__,__FUNCTION__,__CLASS__);
