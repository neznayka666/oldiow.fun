...
if ( $http->_get('buy') and $http->_get("kolvo")>0 and $http->_get("kolvo")<100 and $player->jKey(1) )
{
	...
	$v = $db->sqla("SELECT price,name,id,max_durability,dprice FROM `weapons` WHERE `id`='".$buy."' and (p_type=18 or p_type=17) and `dprice` = 0;", __FILE__,__LINE__,__FUNCTION__,__CLASS__);
	if ( $v )
	{
...
if (!$player->AuraSpecial[20] and !$player->AuraSpecial[21]) {
	...
	<td width=16% class=margin-5 align=center><p>Лицензия на добычу<br> на <b>3 часа</b></p><p><img src='images/weapons/i/lic/lic_forest.gif' alt='Лицензия Лесника'></p><p>Цена: <b>".LFOREST3."</b> зм.</p><p><input type=button class='inv_but' onclick=\"location='main.php?lbuy=3'\" value='Купить'></p></td>
	<td width=16% class=margin-5 align=center><p>Лицензия на добычу<br> на <b>5 часов</b></p><p><img src='images/weapons/i/lic/lic_forest.gif' alt='Лицензия Лесника'></p><p>Цена: <b>".LFOREST5."</b> зм.</p><p><input type=button class='inv_but' onclick=\"location='main.php?lbuy=5'\" value='Купить'></p></td>
	<td width=16% class=margin-5 align=center><p>Лицензия на добычу<br> на <b>8 часов</b></p><p><img src='images/weapons/i/lic/lic_forest.gif' alt='Лицензия Лесника'></p><p>Цена: <b>".LFOREST8."</b> зм.</p><p><input type=button class='inv_but' onclick=\"location='main.php?lbuy=8'\" value='Купить'></p></td>
	<td width=16% class=margin-5 align=center><p>Лицензия на добычу<br> на <b>12 часов</b></p><p><img src='images/weapons/i/lic/lic_forest.gif' alt='Лицензия Лесника'></p><p>Цена: <b>".LFOREST12."</b> зм.</p><p><input type=button class='inv_but' onclick=\"location='main.php?lbuy=12'\" value='Купить'></p></td>
	</tr></table>";
}

$lavka = 1;
$enures= $db->sql("SELECT * FROM `weapons` WHERE (`p_type`='17' or `p_type`='18') AND `where_buy`='0' or `name`='Малый рюкзак' ORDER BY `price` ASC", __FILE__,__LINE__,__FUNCTION__,__CLASS__);
