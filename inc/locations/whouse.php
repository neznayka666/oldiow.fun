      ...
      if ($time > 0)
	  {
        ...
        if ($price > 0){
          ...
          if ($money > 0){
            ...
            say_to_chat ("s","Вы удачно выставили на аукцион <b>".$res["upgrated"]."</b>. Стартовая цена лота: <b>".$price."</b> зм. Торги окончатся: <b>".date("d.m.Y H:i",$time)."</b>",1,$player->pers["user"],'*',0);
          }else{
