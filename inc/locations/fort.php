                        ...
                        <table cellpadding="1" cellspacing="1" width="100%" border="0">
                            <tr>
                                <td bgcolor="#<?php echo (($_GET['addid']==1)?'FFFFFF':'F0F0F0'); ?>" width="20%">
                                    <div align="center"><a href="?addid=1" class="nickname">
                                            <font class=nickname><b>Порталы</b></font>
                                        </a></div>
                                </td>
                                <td bgcolor="#<?php echo (($_GET['addid']==2)?'FFFFFF':'F0F0F0'); ?>" width="20%">
                                    <div align="center"><a href="#?addid=2" class="nickname">
                                            <font class=nickname><b>Обмен ресурсов</b></font>
                                        </a></div>
                                </td>
                                <td bgcolor="#<?php echo (($_GET['addid']==3)?'FFFFFF':'F0F0F0'); ?>" width="20%">
                                    <div align="center"><a href="?addid=3" class="nickname">
                                            <font class=nickname><b>Благословения</b></font>
                                        </a></div>
                                </td>
                                <td bgcolor="#<?php echo (($_GET['addid']==4)?'FFFFFF':'F0F0F0'); ?>" width="20%">
                                    <div align="center"><a href="#?addid=4" class="nickname">
                                            <font class=nickname><b>Лавка</b></font>
                                        </a></div>
                                </td>
                                <td bgcolor="#<?php echo (($_GET['addid']==5)?'FFFFFF':'F0F0F0'); ?>" width="20%">
                                    <div align="center"><a href="?addid=5" class="nickname">
                                            <font class=nickname><b>Штурм</b></font>
                                        </a></div>
                                </td>
                            </tr>
                        </table>
...
?>
                        <table cellpadding="1" cellspacing="1" width="100%" border="0">
                            <tr>
                                <td bgcolor="#<?php echo (($_GET['addid']==6)?'FFFFFF':'F0F0F0'); ?>" width="50%">
                                    <div align="center"><a href="?addid=6" class="nickname">
                                            <font class=nickname><b>Настройки штурма</b></font>
                                        </a></div>
                                </td>
                                <td bgcolor="#<?php echo (($_GET['addid']==7)?'FFFFFF':'F0F0F0'); ?>" width="50%">
                                    <div align="center"><a href="?addid=7" class="nickname">
                                            <font class=nickname><b>Настройки услуг</b></font>
                                        </a></div>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table cellpadding="1" cellspacing="1" width="100%" border="0">
                            <tr>
                                <td bgcolor="#FFFFFF" width="100%">
                                    <center>
                                        <font class=nickname>Островной Форт под контролем клана
                                            <b><?php echo $Fort['clan']; ?></b></font>
                                    </center>
                                </td>
                            </tr>
                        </table>
