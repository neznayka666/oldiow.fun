...
<td width=30%>
<img src='../img/images/bone/bone.jpg' alt='Кости'>
</td>
...
function new_game () {
        ...
        <center>
        Ставка: <SELECT class=standbut name=type><OPTION value='1' selected>10 зм.<OPTION value='2'>25 зм.<OPTION value='3'>50 зм.<OPTION value='4'>100 зм.<OPTION value='5'>200 зм.</OPTION></SELECT><p><input type=submit value='Начать игру' class=standbut>
        </center>
        </FIELDSET>
        </form>
        </td>
...
Выпало:
<center>
<img src='../img/images/bone/<?=$player_1?>.gif' alt='<?=$player_1?>'><p><img src='../img/images/bone/<?=$player_2?>.gif' alt='<?=$player_2?>'>
</center>
<?
  }
?>
...
Выпало:
<center>
<img src='../img/images/bone/<?=$comp_1?>.gif' alt='<?=$comp_1?>'><p><img src='../img/images/bone/<?=$comp_2?>.gif' alt='<?=$comp_2?>'>
</center>
<?
  }
?>
...
?> <input type=button value='Новая игра' class=standbut onclick='window.location.href="gamblinghouse.php?gameroom=1&tmp="+Math.random();""'>
</center>
</FIELDSET>
</form>
</td>
