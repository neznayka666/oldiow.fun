...
<body topmargin="0" style="word-spacing: 0; margin-left: 0; margin-right: 0" leftmargin="0" onresize="on_resize()">
	...
	?>
    <?php
	if(($player->pers["free_stats"]>0) || ($player->pers["free_f_skills"]>0) || ($player->pers["free_m_skills"]>0)) echo '<div class="greenBlock" style="width:90%;text-align:center;"><font class=green>Распределите характеристики!</font> <a href="main.php?go=pers">Распределить</a> | <font class=green>Распределите умения!</font> <a href="main.php?gopers=um">Распределить</a></div>';
	?>
    <?php		
		...
		echo '';
		echo '<div class="redBlock" style="width:90%;margin:0 auto;text-align:center;">';
