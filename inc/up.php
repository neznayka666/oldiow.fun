...
<body topmargin="0" style="word-spacing: 0; margin-left: 0; margin-right: 0" leftmargin="0" onresize="on_resize()">
	...
	?>
    <?php
	if(($player->pers["free_stats"]>0) || ($player->pers["free_f_skills"]>0) || ($player->pers["free_m_skills"]>0)) echo '<div class="greenBlock" style="position:fixed;right:0;"><font class=green>Распределите характеристики!</font> <a href="main.php?go=pers">Распределить</a></div>';
	?>
    <?php		
		...
		echo '';
		echo '<div class="redBlock" style="position:fixed;left:0;">';
